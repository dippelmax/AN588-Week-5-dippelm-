...
# Wrong sd, smaple not population
...
#It looks like a binomial or poisson distribution
...
# Ok so I didn't visually verify the poisson distribution


hist(rpois(1000,3), probability = T )
hist(rnorm(1000,3), probability = T )
hist(rbinom(1000, size = 1000, prob = .003)) # This graph is weird
...
# needed to normalize data set 

z_set <- NULL  
for (i in 1:10000) {
z_set[i] <- mean(sample(s_zombies_killed, 30, replace = TRUE))
 }
quantile(z_set, c(0.025, 0.975))
